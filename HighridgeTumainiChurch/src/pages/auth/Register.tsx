...
export default function Register() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-6 bg-[#F1F5F9] my-10">
      <div className="w-full max-w-md bg-white rounded-xl shadow-sm border border-slate-200 p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-2">Join the HighRidge Tumaini Management Portal</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-600">
          Already a member? <Link to="/login" className="text-cyan-600 font-semibold hover:underline">Sign in here</Link>
        </p>
      </div>
    </div>
  );
